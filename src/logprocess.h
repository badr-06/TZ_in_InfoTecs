...
class logProcessor {
 ...
 public:
  ...
  // Проверка сообщений (возвращает 1 если встреталась цифра, 0 еслипустая
  // строка и 2 в остальных случаях): str - строка для поиска i - индекс
  // совпадения (передается по ссылке)
